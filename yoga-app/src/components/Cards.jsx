...
import CardImg1 from '../assets/img/cards/card-1.png'
import CardImg2 from '../assets/img/cards/card-2.png'
import CardImg3 from '../assets/img/cards/card-3.png'
    ...
    >
      <div className='container mx-auto flex flex-col lg:flex-row gap-x-[32px]'>
        ...
        <div className='flex-1 flex gap-x-[15px] lg:gap-x-[32px] -mt-[38px] lg:-mt-[77px] z-10 mx-auto'>
          {/* card 1 */}
          <div
            className='bg-[#fff] w-full max-w-[282px] p-[14px] lg:p-[26px] shadow-2xl rounded-md max-h-[282px]'
            data-aos='fade-up'
            data-aos-delay='400'
          >
          ...
          {/* card 2 */}
          <div
            className='bg-[#fff] w-full max-w-[282px] p-[14px] lg:p-[26px] shadow-2xl rounded-md'
            data-aos='fade-up'
            data-aos-delay='600'
          >
            <div className='flex items-center mb-[18px] lg:mb-[28px]'>
        ...
        {/* card 3 */}
        <div
          className='bg-[#fff] w-full max-w-[542px] mx-auto p-[14px] lg:p-[26px] mt-4 lg:-mt-[77px] z-10 shadow-2xl rounded-md flex justify-between items-start'
          data-aos='fade-up'
          data-aos-delay='800'
        >
