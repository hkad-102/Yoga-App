      ...
      <div className="container mx-auto">
        ...
        <div className='text-center mb-16 lg:mb:32'>
          ...
          <p className='max-w-[480px] mx-auto' data-aos='fade-down'
            data-aos-delay='300'>Practice anywhere, anytime. Explore a new way to exercise and learn
        ...
        <div className='flex flex-col lg:flex-row lg:gap-x-[33px] gap-y-24 mb-7 lg:mb-14'>
          {courses.map((item, index) => {
            ...
            return (
              <div
                className='w-full max-w-[368px] px-[18px] pb-[26px] lg:px-[28px] lg:pb-[38px] bg-[#fff] hover:shadow-primary flex flex-col rounded-[14px] mx-auto transition'
                data-aos='fade-up'
