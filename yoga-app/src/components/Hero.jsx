      ...
      <div className='container mx-auto'>
        ...
        <div className='flex flex-col items-center lg:flex-row lg:items-start pt-32 lg:pt-32'>
          <div className='flex-1 lg:mt-12'>
            ...
            >Yoga to <br /> Release Stress</h1>
            <p className='mb-6 lg:mb-12 max-x-[480px] lg:text-lg' 
              data-aos='fade-down'
              data-aos-delay='600'
            ...
            >
              ...
              <button className='btn btn-sm lg:btn-lg text-heading bg-transparent border border-stroke-1 px-4 lg:px-4 hover:bg-stroke-3 transition'>Learn More</button>
            </div>
          </div>
